...
from motiondata_lib.importers import amass, lafan1, retargeted_npz, sonic, tiangong3_csv, tiangong3_pkl
...
IMPORTERS = (retargeted_npz, sonic, tiangong3_csv, tiangong3_pkl, lafan1, amass)
